...
\begin{tikzpicture}
   		\node[anchor=south west,inner sep=0] (Bild) at (0,0) {\includegraphics[scale=0.39]{fig4a.pdf}};
   		\begin{scope}[x=(Bild.south east),y=(Bild.north west)]
		\node at (1.5,.5) {\includegraphics[scale=0.39]{fig4b.pdf}};
		
		\draw[black] (0.8675,0.825) node {\tiny \textbf{A}};5
        \draw[black] (1.87,0.825) node {\tiny \textbf{B}};
