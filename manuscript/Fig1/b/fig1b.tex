...
% include your tikz code here
   		\node[anchor=south west,inner sep=0] (Bild) at (0,0) {\includegraphics[scale=0.39]{fig1b_blank.pdf}};
   		\begin{scope}[x=(Bild.south east),y=(Bild.north west)]
			...
			\fill[black] (0.65,0.18) circle (.07cm);
			\draw (0.65,0.18) node[right= 2pt] {\tiny Young et al. (2020)}; 
			\fill[gray] (0.65,0.13) circle (.07cm);   
			\draw (0.65,0.13) node[right= 2pt] {\tiny W{\"o}lfel et al. (2020)}; 			
			\fill[gray,opacity=0.6] (0.65,0.23) circle (.07cm);             	
        	\draw (0.65,0.23) node[right= 2pt] {\tiny To et al. (2020)};
        	
        	\fill[py_olive] (0.65,0.28) circle (.07cm);            
        	\draw (0.65,0.28) node[right= 2pt] {\tiny Kissler et al. (2020)};  
