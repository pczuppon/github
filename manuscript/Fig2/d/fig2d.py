...
################################ neutral
my_data = genfromtxt('surv_HN_eps_0_sc_0_model_1.txt', delimiter=',')
...
#my_data = genfromtxt('surv_HN_eps_025_sc_0_model_1.txt', delimiter=',')
...
#my_data = genfromtxt('surv_HN_eps_025_sc_1_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_HN_eps_05_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_HN_eps_05_sc_1_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_HN_eps_075_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_HN_eps_075_sc_1_model_1.txt', delimiter=',')
...
################################ Plot surv prob
################################
plt.semilogx(V0,np.array(surv1)/np.array(survneu),linewidth=3,color='C0',linestyle='solid')
#plt.plot(eps_data2,np.array(data2)/np.array(data1),'o',color='C0',markersize=10)
plt.plot(V0,np.array(surv2)/np.array(survneu),linewidth=3,color='C1',linestyle='solid')
...
plt.plot(V0,np.array(surv13)/np.array(survneu),linewidth=3,color='C0',linestyle='dashed')
plt.plot(eps_data6,np.array(data6)/np.array(data1),'o',color='C0',markersize=10)
plt.plot(V0,np.array(surv23)/np.array(survneu),linewidth=3,color='C1',linestyle='dashed')
