...
################################ Reducing burst size
my_data = genfromtxt('surv_LN_V0_1_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_LN_V0_1_sc_1_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_LN_V0_10_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_LN_V0_10_sc_1_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_LN_V0_100_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_LN_V0_100_sc_1_model_1.txt', delimiter=',')
...
for i in range(len(eps)):
    ...
    surv2.append(max(0,1-(c/(c+beta2*T)+delta/(p*mu))))
