...
################################ Reducing burst size
my_data = genfromtxt('surv_LB_V0_1_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_LB_V0_1_sc_1_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_LB_V0_10_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_LB_V0_10_sc_1_model_1.txt', delimiter=',')
