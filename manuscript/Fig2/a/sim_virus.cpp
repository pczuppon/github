...
// Initial variables
#define T0 399000        // initial number of target cells (30ml resp tract * 2*10^5 cells /ml)
...
int main(int argc,char *argv[])
{
    ...
    ofstream file ("surv_LB_V0_10_sc_" + std::to_string(scenario) + "_model_" + std::to_string(model) + ".txt", ios::app);   // file output, average
    file << eps;
    file << ",";
    file << avg;  
    file << "\n";
