...
plt.plot(gens_plotc,np.array(pc)/(1/k + 1/(beta*T + c/(1-eps)) + 1/delta),linewidth=3,color='C3')
plt.plot(gens_plotbeta,np.array(pbeta)/(1/k + 1/(beta*(1-eps)*T + c) + 1/delta),linewidth=3,color='C1')
#plt.show()
...
################################
################################ Reducing burst size
data1 = genfromtxt('ext_HN_V0_10_eps_0.9_sc_2_model_1.txt', delimiter=',')
data2 = genfromtxt('ext_HN_V0_10_eps_0.9_sc_1_model_1.txt', delimiter=',')
