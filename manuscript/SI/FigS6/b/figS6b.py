...
################################ Reducing burst size
my_data = genfromtxt('surv_HR_HN_V0_1_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_HR_HN_V0_1_sc_1_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_HR_HN_V0_10_sc_0_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_HR_HN_V0_10_sc_1_model_1.txt', delimiter=',')
...
my_data = genfromtxt('surv_HR_HN_V0_100_sc_0_model_1.txt', delimiter=',')
...
################################ Reducing infectivity, I0=10
my_data = genfromtxt('surv_HR_HN_V0_100_sc_1_model_1.txt', delimiter=',')
